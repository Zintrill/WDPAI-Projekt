...
class DeviceRepository extends Repository
{
    public function getAllDevices()
    {
        $stmt = $this->database->connect()->prepare('
            SELECT d.id, d.device_name, t.type, d.address_ip, s.snmp as snmp_version, d.username, d.password, d.description
...
{
    $stmt = $this->database->connect()->prepare('
        SELECT id, device_name, type_id, address_ip, snmp_version_id, username, password, description
        FROM public.device
        WHERE id = :id
    ');
